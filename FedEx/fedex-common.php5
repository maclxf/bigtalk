...
function getProperty($var){
  ...
  if($var == 'key') Return 'bjrat0CzmBj6OsV5';
	if($var == 'password') Return 'vXds9gGSOJyAzA7akYWK8Yz1y';
	if($var == 'parentkey') Return 'xxxxxxxxxx';
	...
	if($var == 'validateaccount') Return '510087100';
	if($var == 'meter') Return '114016331';
