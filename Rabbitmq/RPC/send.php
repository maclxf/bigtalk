...
// $callback_queue = $channel->queue_declare("",false,false,true,false);

// $channel->basic_consume($callback_queue,'',false,true,false,false,array('','onResponse'));

// $response = null;
// $correlation_id = uniqid();
// $params = ['correlation_id' => $tcorrelation_id,'reply_to' => $callback_queue];

// $message = new AMQPMessage(10,$params);
// $channel->basic_publish($message, '', 'rpc');
// while (!$response) {
//     //等待处理
//     $channel->wait();
// }
